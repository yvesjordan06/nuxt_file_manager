...
<div class="h-screen w-full flex overflow-hidden">
	<nav class="flex flex-col bg-gray-200 dark:bg-gray-900 w-64 px-12 pt-4 pb-6">
		...
		<nuxt-link to="/dashboard/create"
			class="mt-8 flex items-center justify-between py-2 px-2 text-white
			dark:text-gray-200 bg-green-600 dark:bg-green-500 rounded-lg shadow">
			<!-- Action -->
		...
		<ul class="mt-2 text-gray-600">
			...
			<li class="mt-8">
				<router-link to="/dashboard/received/" class="flex">
					<svg
						class="fill-current h-5 w-5 dark:text-gray-300"
						viewBox="0 0 24 24">
						<path
			...
			<li
				...
				-ml-4">
				<router-link to="/dashboard/forwarded"  class="flex pl-4">
					...
					<span class="ml-2 capitalize font-medium">Fowarded</span>
				</router-link>
			</li>
		...
		<div class="mt-auto flex items-center text-red-700 dark:text-red-400">
			<!-- important action -->
			<a href="#home" @click.prevent="doLogout()" class="flex items-center">
				<svg class="fill-current h-5 w-5" viewBox="0 0 24 24">
					<path
